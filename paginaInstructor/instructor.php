...
<a href="pdf.php"> <button  style="width:100%; margin-top:5%;" type="button" class="btn btn-outline-primary  " >Descargar Resumen Técnicas Didácticas <svg width="2em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
