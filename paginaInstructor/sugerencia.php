...
<br><br>
	...
	$resultado = $conecta->query($consulta);
      ...
      if( $fila['respuesta'] == 'Atendido' ) {
       
      echo "<td > <center> <button class='btn btn-success ' style='cursor: default; text.aling:center;' >".$fila['respuesta']." </center></button></td>";

        
      } 
        
      if( $fila['respuesta'] == 'Por responder' ) {
       
        echo "<td ><center> <button class='btn btn-danger ' style='cursor: default; text.aling:center;' >".$fila['respuesta']." </center></button></td>";
		...
		echo"	
			...
			<td class='pdf '><a href='../archivoInstruc/".$fila["pdfUsuario"]."'><img src='../images/ver.png' class='imgPdf'></a></td>
			<td class='eliminar '> <a href='eliminarSugerencia.php?id=".$fila["idSugerencia"]." ' class='btn  btn-danger btn-block ' onclick='return ConfirmDelet()'> Eliminar  </a></td>
