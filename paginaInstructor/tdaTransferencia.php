...
<head>
    <meta charset="UTF-8">
    <title>Tranferencia Del Conocimiento</title>
...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
    ...
    <div style="background:white; margin-top:-32px;" class="bg-red p-5 rounded  shadow-sm ">
        ...
        <p class="lead font-italic mb-0 text-muted">
			<h4  style="float:left; font-size:5vh;font-size:2.5vw;   " > Tranferencia Del Conocimiento</h4>
  ...
  <form action="buscarTransferencia.php" method="get" class="form-inline my-2 my-lg-0" >
      ...
      <div id="tablephp">
        <?php  include('paginado/paginadoTransferencia.php'); ?>
      </div>
