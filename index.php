...
<body id="texto" class="w3-light-grey" style="min-width:100%; max-width:100%;">
  ...
  <div>
    ...
    transition:all 0.5s; max-width:90%; min-width:40vh;margin-top:0.7%" type="text" id="cajaTexto" required />
        ...
        <div class="ingreso">
          <button type="button" class="btn btn-outline-success text-dark" onclick="document.getElementById('subscribe').style.display='block'"><img src="images/ingresar.png" class="ingreso1" style="color: white;">Ingresar</button>
        </div>
      </div>
    </nav>
    <!-- Grid -->
                  ...
                  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="images/slideshow/educationn.jpg" alt="elearning">
                      </div>
                      <div class="carousel-item">
