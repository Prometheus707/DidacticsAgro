...
<h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Transferencia Del Conocimiento</h4>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <div class="w3-row w3-padding w3-border">
    <p class="lead   text-black"><strong>Sr(a) Instructor:</strong> Recuerde que las  actividades  de este campo,  no se encuentran prescritas en la Planeación Pedagógica del Proyecto.  Corresponden al momento <strong> DESPUÉS DE APRENDER </strong>,  el cual busca que los aprendices apliquen o transfieran el aprendizaje desarrollado en la fase anterior a contextos reales.<br>
    El componente <strong> TRANSFERENCIA DEL CONOCIMIENTO</strong> , se define como la garantía de que los conocimientos y las habilidades adquiridas durante una construcción de aprendizaje sean aplicados en los contextos reales. El propósito  es que los aprendices transfieren el 100% de sus conocimientos y habilidades de acuerdo con las funciones productivas, lo que daría como resultado la calidad  de los desempeños  y como  de la gestión de la FPI. Puede utilizar otras TDAs como: demostración práctica o práctica de campo, modelaje de situaciones o casos, solución de problemas, demostración en actividad productiva, talleres, resultados de desempeño, investigación-acción,  profundización de conocimiento, demostración de creatividad y/o innovación (inventar, formular, solucionar problemas, hipótesis)
  </p><br>
  ...
  <form action="buscarTransferencia.php" method="get" class="form-inline my-2 my-lg-0" style=" float:right; margin-top:-50%;">
      ...
      <div id="tablephp">
        <?php  include('paginado/pagingT.php'); ?>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="agregartda/agregarTdaT.php" method="post">
          ...
          <input type="hidden"  class="form-control" style="width: 80%;margin-left: 4%" name="fechaRegTdaTransfe" value="<?php echo $fechaFormateada; ?>" >
...
<div style="margin-left: 4%" >
        <label for="op1">  <input type="checkbox" id="op1" name="momento[]" value="1"> Reflexión Inicial </label>
          ...
          <label for="op4">  <input type="checkbox" id="op4" name="momento[]" value="4"  checked> Transferencia De Conocimiento </label>
    </div>



          <p style="font-size: 18px;padding-left: 4%;"> Añadir Archivo:</p>
		   <input class="form-control" style="width: 80%;margin-left: 4%"  type="file" name="archivo" value=""  id="archivoInput" onchange="return validarExt()" required><br>
...
<script>
                          ...
                          if(isset($_GET['opcion8'])&& $_GET['opcion8']=='true'){
                            ...
                            echo 'swal.fire(
                              "Se actualizó correctamente.","","success"
                              )';
                          }
                          ...
                          if(isset($_GET['opcion9'])&& $_GET['opcion9']=='true'){
                            ...
                            echo 'swal.fire(
                              "Se eliminó correctamente.","","success"
                              )';
                          }
