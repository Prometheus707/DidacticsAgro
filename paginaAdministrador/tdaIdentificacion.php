...
<div class="page-content p-5" id="content">
  ...
  <div style="background:white; margin-top:-30px;" class="bg-red p-5 ps rounded shadow-sm ">
  <button id="sidebarCollapse" type="button" class="btn btn-light bg-white rounded-pill shadow-sm px-4 mb-4"><i class="fa fa-bars mr-2"></i><small class="text-uppercase font-weight-bold">menú</small></button>
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Contextualización e Identificación Del Conocimiento</h4>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <form action="buscarIdentificacion.php"method="get" class="form-inline my-2 my-lg-0" style=" float:right; margin-top:-50%;">
      ...
      <div id="tablephp">
        <?php include('paginado/pagingC.php'); ?>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="agregartda/agregarTdaC.php" method="post">
          ...
          <input type="hidden"  class="form-control" style="width: 80%;margin-left: 4%" name="fechaRegTdaIdenti" value="<?php echo $fechaFormateada; ?>" >
...
<div style="margin-left: 4%" >
        <label for="op1">  <input type="checkbox" id="op1" name="momento[]" value="1"> Reflexión Inicial </label>
          <label for="op2">  <input type="checkbox" id="op2" name="momento[]" value="2" checked> Contextualización E Identificación de conocimientos necesarios para el aprendizaje </label>
...
<div id="visorArchivo">
 <!--Aqui se desplegará el fichero-->
        ...
        <div class="modal-footer">
          <input type="submit" style="margin-right: 3%" class='btn  btn-success' name="enviar" value="enviar">
          </form>
