...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <center><img src="../imagenes/logo3.png" alt="logo"  style=" max-width:20%; min-width:20%;"></center>
      ...
      <form class="" action="actualizarTransfe1.php"  enctype="multipart/form-data"  onSubmit="return validar();" method="post">
...
<br>
 ...
 <br>
	...
	<input type="hidden" name="id" value="<?php echo $id; ?>">
      ...
      <a href="tdaTransferencia.php"><button type="button" class='btn  btn-danger btn-sm' style="width:32%; font-size:2vh;" name="button">Cancelar</button></a>
      </div>
