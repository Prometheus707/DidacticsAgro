...
$id=$_GET['id'];
$consulta = "SELECT * FROM conformarg where idConfor=".$id;
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <center><img src="../imagenes/logo3.png" alt="logo"  style=" max-width:20%; min-width:20%;"></center>
      ...
      <form class="" action="actualizarEquipos1.php"  enctype="multipart/form-data"  onSubmit="return validar();" method="post">
  ...
  <hr><div class="w3-row w3-padding " >
	 ...
	 <div class="w3-col l6 s12">
      ...
      <center>
     <div class="w3-white ">
					Nombre: <textarea name="nombre" style="width:100%" rows="8" cols="80"><?php echo $fila['tituloConfor'] ?></textarea>
      </div>
    </center><br>
      <div class="w3-white ">
...
<center>
   <div class="w3-white ">
  Descripción: <textarea name="descripcion" style="width:92%" rows="8" cols="80"><?php echo $fila['descripcionConf'] ?></textarea>
 </div>
</center>
    </div>
    <div id="visorArchivo">
