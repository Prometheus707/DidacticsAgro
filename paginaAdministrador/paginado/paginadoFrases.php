 ...
 mysqli_set_charset($conecta,"utf8");
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<td style='text-align:center'>".$rows['descripcionFrases']."</td>
          ...
          <td style='text-align:center'><a href=../pdf/".$rows["pdfFrases"]."><img src='../images/ver.png'></a></td>
          <td style='text-align:center'> <a href='actualizarFrases.php?id=".$rows['idFrases']."'> <input class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Actualizar'></a></td>
          <td style='text-align:center'> <a href='eliminarFrases.php?id=".$rows['idFrases']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Eliminar'></a></td>";
