 ...
 mysqli_set_charset($conecta,"utf8");
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<td style='white-space:pre-line'>".$rows['descripcionRompe']."</td>
          ...
          <td> <a href='actualizarRompe.php?id=".$rows['idRompeH']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Actualizar'></a></td>
          
          <td> <a href='eliminarRompe.php?id=".$rows['idRompeH']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Eliminar'></a></td>
          ";
