 ...
 mysqli_set_charset($conecta,"utf8");
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<td>".$rows['descripcionConf']."</td>
          ...
          <td> <a href='actualizarEquipos.php?id=".$rows['idConfor']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Actualizar'></a></td>
          <td> <a href='eliminarEquipos.php?id=".$rows['idConfor']."'> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Eliminar'></a></td>
