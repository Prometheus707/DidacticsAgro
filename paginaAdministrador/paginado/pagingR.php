...
$count="SELECT COUNT(*) FROM tda where idTipoTdas='1'";
 ...
 mysqli_set_charset($conecta,"utf8");
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<td id='t9'> <a href='eliminarRefle.php?id=".$rows['idTda']."' onclick=\"return confirmar('¿Está seguro que desea eliminar el registro?')\"> <input  class='btn   btn-sm' style='color: green; font-size: 18px' type='button' value=' Eliminar'></a></td>";
