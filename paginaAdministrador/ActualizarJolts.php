...
$id=$_GET['id'];
$consulta = "SELECT * FROM motivdores where idMotivadores=".$id;
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <center><img src="../imagenes/logo3.png" alt="logo"  style=" max-width:20%; min-width:20%;"></center>
      ...
      <form class="" action="actualizarJolts1.php"  enctype="multipart/form-data"  onSubmit="return validar();" method="post">
  ...
  <hr><div class="w3-row w3-padding " >
	 ...
	 <div class="w3-col l6 s12">
      ...
      <center>
     <div class="w3-white ">
					Nombre: <textarea name="nombre" style="width:100%" rows="8" cols="80"><?php echo $fila['tituloMoti'] ?></textarea>
      </div>
    </center><br>
      <div class="w3-white ">
        <p>Por favor vuelva a elegir la gráfica para que sea cargada nuevamente.</p>
     Gráfica:<br> <input type="file" name="grafica" value="" id="archivoInput" onchange="return validarExt()" required>
 </div><br><br>
...
<center>
   <div class="w3-white ">
  Descripción: <textarea name="descripcion" style="width:92%" rows="8" cols="80"><?php echo $fila['descripcionMoti'] ?></textarea>
 </div>
</center>
    </div>
    <div id="visorArchivo">
	...
	<input type="hidden" name="id" value="<?php echo $id; ?>">
      ...
      <a href="tdaJolts.php"><button type="button" class='btn  btn-danger btn-sm' style="width:32%; font-size:2vh;" name="button">Cancelar</button></a>
      </div>
...
<?php } ?>
    ...
    <footer style="background-color: <?php echo $var_color_sena; ?>;  margin-top:-2%;">
