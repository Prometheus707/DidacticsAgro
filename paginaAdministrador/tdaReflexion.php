    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="agregartda/agregarTda.php" method="post">
          ...
          <input type="hidden"  class="form-control" style="width: 80%;margin-left: 4%" name="fechaRegTda" value="<?php echo $fechaFormateada; ?>" >
          <p style="font-size: 18px;padding-left: 4%">Descripción:</p>
          <textarea class="form-control" style="width: 80%;margin-left: 4%" name="descripcion" value="" required></textarea><br>
