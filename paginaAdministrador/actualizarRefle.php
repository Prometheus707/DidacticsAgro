...
<div style="background:<?php echo $var_color_sena; ?>; ">
    <center><img src="../imagenes/logo3.png" alt="logo"  style=" max-width:20%; min-width:20%;"></center>
      ...
      <form class="" action="actualizarTda2.php" enctype="multipart/form-data"  onSubmit="return validar();" method="post">
  	<h4  style=" font-size:5vh;font-size:2vw;  text-align:center; width:100%; "  > Actualizar Técnica Didáctica  <strong><?php echo $fila['nombreTda']; ?> </strong></h4>
	 ...
	 <div class="w3-col l6 s12">
      <div class="w3-container w3-white  subirn " >
        <div class="w3-justify">
           <div class="w3-white ">
						<br>
                    <p> Titulo: </p> <input type="text" class="form-control" style="width: 80%;" name="nombretda" value="<?php echo $fila['nombreTda']; ?>" required><br>

 <p> Descripción: </p>
      <textarea rows="9.5" cols="20" style="width: 90%;" class="form-control" name="descripcion" type="text" required><?php echo $fila['descripcionTda']; ?></textarea><br>
...
<br>
 ...
 <br>
	...
	<input type="hidden" name="id" value="<?php echo $id; ?>">
      ...
      <a href="tdaReflexion.php"><button type="button" class='btn  btn-danger btn-sm' style="width:32%; font-size:2vh;" name="button">Cancelar</button></a>
      </div>
