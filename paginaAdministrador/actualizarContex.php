...
<div style="background:<?php echo $var_color_sena; ?>; ">
    <center><img src="../imagenes/logo3.png" alt="logo"  style=" max-width:20%; min-width:20%;"></center>
      ...
      <form class="" action="actualizarContex1.php" enctype="multipart/form-data"  onSubmit="return validar();" method="post">
...
<br>
 ...
 <br>
	...
	<input type="hidden" name="id" value="<?php echo $id; ?>">
      ...
      <a href="tdaIdentificacion.php"><button type="button" class='btn  btn-danger btn-sm' style="width:32%; font-size:2vh;" name="button">Cancelar</button></a>
      </div>
