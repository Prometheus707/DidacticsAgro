...
<div class="page-content p-5" id="content">
  ...
  <div style="background:white; margin-top:-30px;" class="bg-red p-5 pl rounded shadow-sm ">
  <button id="sidebarCollapse" type="button" class="btn btn-light bg-white rounded-pill shadow-sm px-4 mb-4"><i class="fa fa-bars mr-2"></i><small class="text-uppercase font-weight-bold">menú</small></button>
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " >  Apropiación Del Conocimiento</h4>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <div class="w3-row w3-padding w3-border">
    <p class="lead   text-black"><strong>Sr(a) Instructor:</strong> Recuerde que las  actividades  de este campo,  se encuentran prescritas en la Planeación Pedagógica del Proyecto como el "QUE" y en la guía de aprendizaje son el "CÓMO". Corresponden al momento <strong>MIENTRAS APRENDE</strong>.<br>
  ...
  <form action="buscarApropiacion.php" method="get" class="form-inline my-2 my-lg-0" style=" float:right; margin-top:-50%;">
      ...
      <div id="tablephp">
        <?php  include('paginado/pagingA.php');  ?>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="agregartda/agregarTdaA.php" method="post">
          ...
          <input type="hidden"  class="form-control" style="width: 80%;margin-left: 4%" name="fechaRegTdaApropi" value="<?php echo $fechaFormateada; ?>" >
...
<div style="margin-left: 4%" >
        <label for="op1">  <input type="checkbox" id="op1" name="momento[]" value="1"> Reflexión Inicial </label>
          ...
          <label for="op3">  <input type="checkbox" id="op3" name="momento[]" value="3" checked> Apropiación De Conocimiento </label><br>
