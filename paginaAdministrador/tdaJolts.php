...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
	...
	<h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " >Jolts y Motivadores</h4>
...
<!-- Grid -->
  ...
  <p class="lead   text-black"> La importancia de la motivación de los aprendices radica en su repercusión para la consecución de los objetivos y la mejora del rendimiento académico. La motivación es un factor que debe ser tenido en cuenta por centros educativos y todos los Instructores, con la intención de fomentar el interés de los aprendices en su formación y favorecer un mejor desarrollo cognitivo. Cuando se habla de motivación hace referencia a un estado interno que activa, impulsa e incita a los aprendices a mantener una determinada conducta para alcanzar sus objetivos o metas. La motivación está constituida por una serie de factores que provocan en una persona el deseo de realizar un conjunto de acciones para conseguir sus propósitos. Es la energía que empuja a desarrollar una acción o mantener un determinado comportamiento.</p>
  ...
  <form action="buscarJolts.php" method="get" class="form-inline my-2 my-lg-0" style=" float:right; margin-top:-50%;">
      ...
      <div id="tablephp">
        <?php  include('paginado/pagingJolts.php'); ?>
      </div>
      ...
      <a href="../pdf/ANEXOJOLTS_MOTIVADORES.pdf"> <button  style="width:100%; margin-top:5%;" type="button" class="btn btn-outline-success  " > Descargar RESUMEN DE JOLT Y MOTIVADORES <svg width="2em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" d="M4.406 1.342A5.53 5.53 0 0 1 8 0c2.69 0 4.923 2 5.166 4.579C14.758 4.804 16 6.137 16 7.773 16 9.569 14.502 11 12.687 11H10a.5.5 0 0 1 0-1h2.688C13.979 10 15 8.988 15 7.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 2.825 10.328 1 8 1a4.53 4.53 0 0 0-2.941 1.1c-.757.652-1.153 1.438-1.153 2.055v.448l-.445.049C2.064 4.805 1 5.952 1 7.318 1 8.785 2.23 10 3.781 10H6a.5.5 0 0 1 0 1H3.781C1.708 11 0 9.366 0 7.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383z"/>
      <path fill-rule="evenodd" d="M7.646 15.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 14.293V5.5a.5.5 0 0 0-1 0v8.793l-2.146-2.147a.5.5 0 0 0-.708.708l3 3z"/>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Añadir Jolts y motivadores</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body" >


          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="agregartda/agregarJolts.php" method="post">
